...
export default function Setting() {
  ...
  //     router.push(`${process.env.EXPO_PUBLIC_ROUTE_LENDER_DASH}/editDatapribadi`);
  //   };
  //   const editDatausaha = () => {
  //     router.push(`${process.env.EXPO_PUBLIC_ROUTE_LENDER_DASH}/editDatausaha`);
  //   };
  //   const editDatadarurat = () => {
  //     router.push(`${process.env.EXPO_PUBLIC_ROUTE_LENDER_DASH}/editDatadarurat`);
  //   };
